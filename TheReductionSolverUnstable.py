import os
Seat = r"C:\Users\magic\source\repos\WordReductionSolver\WordReductionSolver\2of12inf.txt"
...
def merge_files(folder, output_path): #Function that merges all text files in a folder into one text file.
    ...
    with open(output_path, "w") as out: 
        ...
        merge_files(r"C:\Users\magic\source\c:\Users\magic\source\repos\WordReductionSolver\WordReductionSolver\MergedTxtFiles") #Calls the merge_files function and specifies the folder containing the text files to be merged and the output path for the merged file.
